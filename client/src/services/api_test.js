...
const API_BASE_URL = undefined || (isClientBrowser && !window.location.hostname.includes("localhost") ? `${window.location.origin}/api` : "http://localhost:5000/api");
const SERVER_BASE_URL = undefined || (isClientBrowser && !window.location.hostname.includes("localhost") ? window.location.origin : "http://localhost:5000");
